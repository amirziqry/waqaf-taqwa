...
const response = await api.patch(`/admin/users/account/password`, requestBody);
```

### Admin — Delete (200)

```javascript
const response = await api.delete(`/admin/users/${frontend.username}`);
```
...
const response = await api.put("/user/users/account", requestBody);
```
...
const response = await api.patch("/user/users/account/password", requestBody);
```
...
const frontend.object = {
    frontend.var: response.data.username, // Donation id
    frontend.var: response.data.role,
};
```
...
```javascript
const response = await api.delete(`/organization/news/${frontend.newsId}`);
```
...
const response = await api.put("/organization/about/image-keys", requestBody);
```
...
const response = await api.post("/rakan-qr/register/otp/request", request);
```
...
const response = await api.post("/rakan-qr/register/otp/verify", request);
```
...
const response = await api.post("/rakan-qr/register/ekyc", request);
```
...
const response = await api.post("/rakan-qr/register/face-id", request);
```
