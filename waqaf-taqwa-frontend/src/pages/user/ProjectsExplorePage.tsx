...
import { getAllProjects } from "../../api/services/projects/ProjectService";
...
const FALLBACK_PROJECTS: CampaignItem[] = [
  {
    ...
    description:
      "Peluasan ruang solat utama bagi menampung pertambahan jemaah solat Jumaat dan aktiviti komuniti.",
    image:
  ...
  },
  {
    ...
    description:
      "Bantuan pembiayaan yuran pengajian, asrama, dan penyediaan mushaf Al-Quran bagi pelajar asnaf.",
    image:
      "https://images.unsplash.com/photo-1584697964190-7bb9b1f72787?auto=format&fit=crop&w=800&q=80",
  },
];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 rounded-3xl border border-slate-100 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Terokai inisiatif pembangunan, pendidikan, dan masjid
          </p>
        </div>
            ...
            >
              <div>
                ...
                <div className="p-5 space-y-3">
                  <h3 className="font-extrabold text-base text-[#0F2028] line-clamp-1">
                    {item.images?.[0]?.url}
                    {item.title}
                  </h3>
