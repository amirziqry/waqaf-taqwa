...
public class AdminDashboardFlowTest {
	...
	void setup() {
		...
		// PROJECT
		CommonClass.createMockProjectDonation(transactionRepository, personalDonationRepository, p1, c1,
				new BigDecimal("200.00"), PaymentStatus.PAID, LocalDateTime.of(2026, month, 12, 15, 0, 0));
		CommonClass.createMockProjectDonation(transactionRepository, personalDonationRepository, p2, c1,
		...
		CommonClass.createMockRakanQrDonation(transactionRepository, agentDonationRepository, r1,
				new BigDecimal("150.00"), PaymentStatus.PAID, LocalDateTime.of(2026, month, 3, 11, 0, 0));
		CommonClass.createMockRakanQrDonation(transactionRepository, agentDonationRepository, r2,
				new BigDecimal("75.00"), PaymentStatus.PAID, LocalDateTime.of(2026, month, 14, 13, 30, 0));
		CommonClass.createMockRakanQrDonation(transactionRepository, agentDonationRepository, r1,
				new BigDecimal("50.00"), PaymentStatus.PAID, LocalDateTime.of(2026, month, 22, 17, 0, 0));

		// Rakan QR - should NOT be included
		CommonClass.createMockRakanQrDonation(transactionRepository, agentDonationRepository, r2,
				new BigDecimal("100.00"), PaymentStatus.UNPAID, LocalDateTime.of(2026, month, 25, 19, 0, 0));
	}
