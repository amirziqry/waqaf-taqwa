...
public class AdminFlowTest {
	...
	@BeforeEach
	void setup() {
		CommonClass.createMockAdmin(accountRepository, passwordEncoder, "member1", "member1@gmail.com", Role.EDITOR);
		CommonClass.createMockAdmin(accountRepository, passwordEncoder, "member2", "member2@gmail.com", Role.EDITOR);
		CommonClass.createMockAdmin(accountRepository, passwordEncoder, "member3", "member3@gmail.com", Role.ADMIN);
		CommonClass.createMockAdmin(accountRepository, passwordEncoder, "member4", "member4@gmail.com", Role.EDITOR);
	}
