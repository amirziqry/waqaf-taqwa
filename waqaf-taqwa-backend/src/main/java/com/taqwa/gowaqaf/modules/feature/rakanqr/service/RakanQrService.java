...
public interface RakanQrService {
	...
	RakanQr getRakanQrByUser(CustomUserDetails principal);

	RakanQrInfo getRakanQrInfoByUser(CustomUserDetails principal);
	...
	RakanQrInfo createRakanQr(CustomUserDetails principal, RakanQrApplicationRequest request);
